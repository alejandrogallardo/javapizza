package com.leksilab.leksipizzeria.web.controller;

import com.leksilab.leksipizzeria.persistence.entity.PizzaEntity;
import com.leksilab.leksipizzeria.service.PizzaService;
...
//    public ResponseEntity<List<PizzaEntity>> getAvailable() {
    public ResponseEntity<Page<PizzaEntity>> getAvailable(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "8") int elements, @RequestParam(defaultValue = "price") String sortBy) {
